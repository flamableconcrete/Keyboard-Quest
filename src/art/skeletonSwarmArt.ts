...
/**
 * Draws the STATIC parts common to all skeleton animation frames: skull, ribcage,
 * armor scraps, pelvis, and left arm. Legs, right arm, and weapon are intentionally
 * omitted — callers draw those per-frame.
 */
